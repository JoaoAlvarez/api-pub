...
import br.com.api.resources.utils.URL;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
		...
		Page<Produto> listProduto = service.search(nomeDecoded, ids, page, linesPerPage, orderBy, direction);
		
		Page<ProdutoDTO> listDto = listProduto.map(obj -> new ProdutoDTO(obj)); 
		/*
		 * DTO == ADAPTER
		 * Steam.map serve para percorrer toda a lista
		*e para cada iten da lista fazer o new ProdutoDTO
		*/
